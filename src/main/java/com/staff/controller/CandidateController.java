...
public class CandidateController {
    ...
    public ResponseEntity<String> saveAttachment(@PathVariable("id") Long candidateId,
                                                 @DefaultValue ("CV") @RequestParam("attachmentType") String attachmentType,
        ...
        String linkToS3 = saveFilesToAWS(Arrays.asList(file));
        //if (content == null)
        ...
        attachment.setfilePath( linkToS3 );
    ...
    private String saveFilesToAWS(List<MultipartFile> files) throws Exception {

        logger.debug("Starting store file to S3...");
        String retlink = new String();
        ...
        for (MultipartFile file : files) {
            ...
            try {
                ...
                metadata.setContentLength(byteBuffer.length);
                s3Client.putObject(new PutObjectRequest(Attachment.BUCKET_NAME, file.getOriginalFilename(), file.getInputStream(), metadata));
                retlink = s3Client.getResourceUrl(Attachment.BUCKET_NAME, file.getOriginalFilename());
                ...
                /*TransferManager tm = TransferManagerBuilder.standard()
                        ...
                        .build();
                Upload upload = tm.upload(Attachment.BUCKET_NAME, file.getOriginalFilename(), file.getInputStream());
